...
<body class="w-full">
    ...
    <main class="w-full">
        <section class="w-full" id="home">
            <div class="bg-[url('../../public/img/op.jpg')] w-full h-[30rem] bg-cover bg-no-repeat">
                <div class="p-20 flex justify-center items-start h-full flex-col sm:max-w-1/3 border border-b-gray-700">    
                    <h1 class="text-5xl md:min-w-96 text-zinc-800">O que a ETEC da Zona Leste pode oferecer</h1>
                    <p class="md:w-1/3 md:min-w-96 text-balance text-zinc-800 py-5">Lorem ipsum dolor sit amet. Est exercitationem aliquam et asperiores autem et velit nostrum ut galisum eveniet et rerum quia id rerum corrupti.</p>
                </div>    
            </div>
        </section>
        ...
        <section id="sobrenos">
            <div class="container flex flex-col gap-10">
                <div class="flex-1">
                    <h2 class="section__title py-5">Oportunidades</h2>
